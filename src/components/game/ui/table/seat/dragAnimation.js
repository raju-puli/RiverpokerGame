...
export class AnimationHere extends React.Component {
    constructor(props) {
        super(props);
        this.imagegif = [axegif, fish, money, tissue, fishstick]
        this.updatevalue = 0
        this.state = {
    ...
    loadImage() {
        ...
        this.image.src = axe1;
        this.image1.src = fish1;
        this.image2.src = money1;
        this.image3.src = tissues1;
        this.image4.src = fishstick1;
    ...
    TargetPositionId2(e, dragdetails) {
        ...
        this.setState({ showpot: true, gifanimationposition: { x: this.props.x1[e].x, y: this.props.y1[e].y, } })
    ...
    render() {
        ...
        return (
            ...
            /> */}
                ...
                <Group>
                    {this.state.hidegif && <GIF src={this.imagegif[this.updatevalue]} sceonds={5} visible1={this.visible.bind(this)} x={this.state.gifanimationposition.x} y={this.state.gifanimationposition.y - 80} />}
