...
export default class BoardCards extends Component {
    constructor(props) {
        ...
        this.y = this.props.tableOriantationLandscape ? 190 : 280;
        ...
        // this.cardSound = new Audio(cardSound).play().catch((e) => console.log(e));
    ...
    addCards(card, text, delay) {
        switch (card) {
            case "flopZero":
                // this.setState({ flopZeroCard: text });
                ...
                break;
            case "flopOne":
                // this.setState({ flopOneCard: text });
                setTimeout(() => {
                ...
                break;
            case "flopTwo":
                // this.setState({ flopTwoCard: text });
                setTimeout(() => {
    ...
    render() {
        // return <Stage container="boardCards" width={this.state.stageWidth} height={this.state.stageHeight}>
        return (
            <Layer>
                {this.state.flopZero.show && <Card ref={this.flopZeroCardRef} x={this.x + this.props.xPadding * -2.5} y={this.y} frame={this.mapCards[this.state.flopZeroCard]} scale={this.props.scale} alpha={this.state.flopZero.alpha} visible={getDealerCardAnimation()} cardStyle={this.state.cardStyle} angled={0}></Card>}

                {this.state.flopOne.show && <Card ref={this.flopOneCardRef} x={this.x + this.props.xPadding * -1.5} y={this.y} frame={this.mapCards[this.state.flopOneCard]} scale={this.props.scale} alpha={this.state.flopOne.alpha} visible={getDealerCardAnimation()} cardStyle={this.state.cardStyle} angled={0}></Card>}

                {this.state.flopTwo.show && <Card ref={this.flopTwoCardRef} x={this.x + this.props.xPadding * -0.5} y={this.y} frame={this.mapCards[this.state.flopTwoCard]} scale={this.props.scale} alpha={this.state.flopTwo.alpha} visible={getDealerCardAnimation()} cardStyle={this.state.cardStyle} angled={0}></Card>}

                {this.state.turn.show && <Card ref={this.turnCardRef} x={this.x + this.props.xPadding * 0.5} y={this.y} frame={this.mapCards[this.state.turnCard]} scale={this.props.scale} alpha={this.state.turn.alpha} visible={getDealerCardAnimation()} cardStyle={this.state.cardStyle} angled={0}></Card>}

                {this.state.river.show && <Card ref={this.riverCardRef} x={this.x + this.props.xPadding * 1.5} y={this.y} frame={this.mapCards[this.state.riverCard]} scale={this.props.scale} alpha={this.state.river.alpha} visible={getDealerCardAnimation()} cardStyle={this.state.cardStyle} angled={0}></Card>}
            </Layer>
        );
        // </Stage>
    }
