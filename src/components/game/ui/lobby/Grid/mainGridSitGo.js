...
export const MainGridSitGo = (props) => {
  ...
  useEffect(() => {
    if (props.data[0].name === "No Sit&Go's Matching Your Search Criteria") {
      setStyle(true);
    } else {
      setStyle(false);
    }
  ...
  useEffect(() => {
    ...
    eventEmitter.on("reload_sitgo_games", handleScrollEvent);
    return () => eventEmitter.off("reload_sitgo_games", handleScrollEvent);
  }, []);
  ...
  }, [prevRow, tabledata, data, network, setAction, setOpenAction, singleClick]);
        ...
        <thead>
          <div className="df table_header_row" style={{ width: '100%', alignItems: 'center' }}>
            ...
            <div className="df row" style={{ color: '#ffff', padding: '0px 0px 0px 15px' }}>
              <button className="table_type_dropdown col-lg-4 col-xl-4 col-xxl-4 bold">Name</button>
              ...
              <button className="table_type_dropdown df_al col-lg-2 col-xl-2 col-xxl-2 bold" name="stakes_filter" onClick={(e) => openDropDown(e)}>Buy-In
                <span className="m_l_5" id="sitgo_stakes_filter_toggle">
              ...
              <button className="table_type_dropdown col-lg-2 col-xl-2 col-xxl-2 bold">Players</button>
              <button className="table_type_dropdown df_al col-lg-2 col-xl-2 col-xxl-2 bold" name="seats_filter" onClick={(e) => openDropDown(e)}>Status
                <span className="m_l_5" id="sitgo_seats_filter_toggle">
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#b79301">
                    <path d="M480-328 225-583h510L480-328Z" />
                  </svg>
                </span>
