...
function SitGoDetails(props) {
    ...
    return (
        <>
            {/* {(fileName.name == "Leader_bet" || fileName.name == "Riverpoker") && <img className="col-12 bdrgold" src={fileName.name !== "Riverpoker" ? bannenr : rv_banner} style={{ padding: "0px", maxHeight: fileName.name === "Riverpoker" ? "16vh" : "12vh", position: "absolute", top: fileName.name === "Riverpoker" ? "-123px" : "-108px", left: "0px" }} />} */}
            ...
            <div className="fd">
                ...
                <div>
                    ...
                    <div className="df_jc_ac p_5">
                        <span className="col-6 d_flex jcs">{props.t("Type")}:</span><span className="col-6 d_flex jce">{props.data.typeText}</span>
                    </div>
                    <div className="df_jc_ac p_5">
                ...
                {
                    ((props.t("Registering") == props.data.status || props.t("Late Registration") == props.data.status) && props.data.id != undefined) &&
                    (
...
export default withTranslation()(SitGoDetails)